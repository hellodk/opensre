"""Tests for the Keycloak admin events tool."""
...
class TestKeycloakAdminEventsToolContract(BaseToolContract):
    def get_tool_under_test(self):
        return get_keycloak_admin_events.__opensre_registered_tool__


def test_metadata() -> None:
    rt = get_keycloak_admin_events.__opensre_registered_tool__
    assert rt.name == "get_keycloak_admin_events"
...
def test_run_happy_path() -> None:
    ...
    with patch(
        "integrations.keycloak.tools.keycloak_admin_events_tool.get_admin_events",
