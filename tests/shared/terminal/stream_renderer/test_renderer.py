...
from surfaces.shared.terminal.stream_renderer import StreamRenderer, _canonical_node_name
...
class TestStreamRendererDiagnoseStreaming:
    ...
    def test_diagnose_skips_rich_live_when_repl_safe(
        ...
        from surfaces.shared.terminal.stream_renderer import diagnose as diagnose_module
        from surfaces.shared.terminal.stream_renderer import renderer as renderer_module
...
class TestStreamRendererFocusedUXAndParsing:
    ...
    @patch("surfaces.shared.terminal.stream_renderer.diagnose.Live")
    @patch("surfaces.shared.terminal.output.tracker._EventLogDisplay")
    @patch.dict(os.environ, {"TRACER_OUTPUT_FORMAT": "rich"})
...
class TestStreamRendererDiagnoseThrottle:
    ...
    def _install_clock_and_spy(self, monkeypatch) -> tuple[list[float], list[int]]:
        ...
        """
        from surfaces.shared.terminal.stream_renderer import diagnose as renderer_module
