...
from surfaces.shared.terminal.stream_renderer.diagnose import _DiagnoseStreamRenderer
from surfaces.shared.terminal.stream_renderer.formatting import (
    _validity_score_percent,
    investigation_llm_progress_hint,
)
from surfaces.shared.terminal.stream_renderer.reasoning import reasoning_text
from surfaces.shared.terminal.stream_renderer.terminal import (
    _print_connection_banner,
    _print_info,
)
from surfaces.shared.terminal.stream_renderer.tools import (
    _tool_event_key,
    _tool_input,
    _tool_output,
)
...
class StreamRenderer:
    ...
    def _print_report(self) -> None:
        from surfaces.shared.terminal.output import stop_display
