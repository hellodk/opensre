...
- Optional coding-agent CLI (Pi, Claude Code, or Codex) for findings that need broader reasoning
...
| **No coding agent found** | Install/login Pi, Claude Code, or Codex, or pin `CODING_AGENT` |
