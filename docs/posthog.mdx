...
This REST integration does **not** register investigation tools. For agent tools during investigations (analytics, feature flags, HogQL), use [PostHog (MCP)](/posthog-mcp).
