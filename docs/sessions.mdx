...
| --- | --- |
| `/sessions` | List recent REPL sessions (name, duration, turns, investigations) |
...
```
  Recent sessions
   ...
   ─────────────────────────────────────────────────────────────────────────────────────────────────
   1  3f8a1c2d    (current)                      2024-01-15 10:00   42m       8      2
   2  9b2e4f7a    why is CPU spiking on prod-api  2024-01-14 14:30   1h 5m    15     4
   3  c1d3e8f2    investigate OOM killer          2024-01-13 09:10   12m       3      1
```
