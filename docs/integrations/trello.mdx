...
There is no registered Trello tool package in the investigation planner today. The integration library exposes:
...
| **No Trello tools in investigation plan** | Expected today — there is no registered Trello investigation tool package yet |
