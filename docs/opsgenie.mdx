...
OpenSRE queries OpsGenie for active alerts and alert details so investigations can
...
| `opensre integrations setup opsgenie` | Not available — use `opensre onboard`, env vars, or the store |
